 ...
 * calibration parameters and see if everything done prior makes sense   *
 *                                                                       *
	...
	TH2F *SX3_EvP[12][4]; //Energy vs Position Histograms for 12 upstream SX3 Detectors
 	for (int i=0; i<12; i++){ //Loop over all detectors
		for (int j=0; j<4; j++){ //Loop over Strips
			...
			SX3_EvP[i][j] = new TH2F(nameSX3_EvP.c_str(), "SX3 upstream Energy vs Position",1000,-10,100,1000,0,12000);
